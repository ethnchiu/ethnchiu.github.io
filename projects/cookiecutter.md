...
<img height="300px" src="../img/cookiecutter/github.png" class="rounded float-end ps-4">
...
<img height="300px" src="../img/cookiecutter/pypi.png" class="rounded float-start ps-4">
